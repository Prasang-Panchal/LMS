...
const CourseDetails = () => {
  ...
  //Destructure the required functions and data from the context
  const {
    allCourses,
    calculateRating,
  ...
  //Function to toggle the section open and close based on the index of the section
    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p className="text-sm">
            Course by <span className="text-blue-600 underline">Prasang</span>
          </p>
